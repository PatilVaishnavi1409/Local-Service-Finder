...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero-section {
            background: linear-gradient(rgba(78, 115, 223, 0.85), rgba(111, 66, 193, 0.85)), url('https://images.unsplash.com/photo-1560472354-b33ff0c44a43?ixlib=rb-4.0.3&auto=format&fit=crop&w=1300&q=80');
        ...
        .cta-section {
            background: linear-gradient(rgba(78, 115, 223, 0.9), rgba(111, 66, 193, 0.9)), url('https://images.unsplash.com/photo-1516387938699-a93567ec168e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1300&q=80');
            background-size: cover;
            background-position: center;
            color: white;
            padding: 100px 0;
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="book_service.php">Book Service</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container py-5">
            ...
            <div class="service-category">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-content">
                                ...
                                <a href="service.php" class="btn btn-sm btn-outline-primary">Find Plumbers</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            <img src="https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Electrical" class="service-img">
                            <div class="service-content">
                                <h4 class="service-title">Electrical</h4>
                                <p>Wiring, repairs, installations by certified electricians.</p>
                                <a href="service.php" class="btn btn-sm btn-outline-primary">Find Electricians</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-content">
                                ...
                                <a href="service.php" class="btn btn-sm btn-outline-primary">Find Cleaners</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-content">
                                ...
                                <a href="service.php" class="btn btn-sm btn-outline-primary">Find Experts</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="service-category">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            <img src="https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Doctors" class="service-img">
                            <div class="service-content">
            ...
            <div class="service-category">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Car Rental" class="service-img">
                            <div class="service-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Moving Services" class="service-img">
                            <div class="service-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-card">
                            <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Property Rental" class="service-img">
                            <div class="service-content">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <a href="signup.php" class="btn btn-light btn-lg">Register Your Service</a>
        </div>
    </section>
